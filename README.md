...
In the context of your project, BERT Fine-tuning is the process of taking the pre-trained bert-base-uncased language model and training it further on your synthesized, class-balanced litigation datasets.

Instead of relying on naive keyword matching or rigid regex heuristics, fine-tuning adjusts BERT's attention weights to capture the dense semantic relationships and subtle adversarial nuances specific to legal discourse. This domain adaptation is what transforms the general model into a highly specialized Legal Contradiction Classifier capable of predicting CONTRADICTS edges between opposing claims with an outstanding ~89% F1-Score, serving as the architectural backbone of your entire Knowledge Graph.
...
<img width="1189" height="490" alt="download (12)" src="https://github.com/user-attachments/assets/38f69943-f64f-489e-8cea-06e2bc048744" />

<img width="896" height="396" alt="download (13)" src="https://github.com/user-attachments/assets/1df75602-a2ca-45d0-a7fa-d9cebcf73a89" />


* **Analysis**: The fine-tuned BERT model achieved an **F1-Score of ~89%**, demonstrating absolute robustness in understanding complex, domain-specific legal contradictions. The poor performance of the Rule-Based approach (~49% F1) underscores that static keyword matching and regex heuristics are entirely inadequate for processing sophisticated semantic conflicts in legal text.
...
[LegalQA] Processing: Did the defendant knowingly misuse customer funds?...
  ...
  Defense claims:     24
  Contradictions:     24
  [OpenRouter] Rate limit — waiting 30s...
  Graph saved: ./graph.html (55 nodes)

════════════════════════════════════════════════════════════════════
 QUESTION: Did the defendant knowingly misuse customer funds?
════════════════════════════════════════════════════════════════════
**PROSECUTION POSITION:**  
The prosecution contends that the defendant knowingly filed materially false financial statements with the SEC in order to inflate the company’s stock price.  It further alleges that the defendant deliberately concealed material risks and diverted investor funds for personal enrichment, demonstrating a conscious intent to mislead investors.

**DEFENSE COUNTER‑ARGUMENT:**  
The defense argues that the defendant did not sell shares during the relevant period and therefore lacked any motive to boost the stock price.  It maintains that the defendant acted in good faith, believing all representations to investors were accurate, and that any inaccuracies in financial projections were honest mistakes rather than intentional fraud, noting the defendant’s existing legitimate wealth as evidence of no personal financial motive.

**COURT RESOLUTION:**  
The court found the evidence of knowing misrepresentation overwhelming, relying on the stock transaction history and email communications to conclude that the defendant knowingly misused customer funds.

────────────────────────────────────────────────────────────────────
 CONTRADICTIONS FOUND BY BERT: 24

  [███████████████░] 96%  Topic: CONSPIRACY
  [PROSECUTION]: The government maintains defendant deliberately concealed material risks and used investor funds for...
  ⟺  CONTRADICTS
  [DEFENSE]: The defense argues the Organized crime ring acted in good faith and genuinely believed all represent...
  ✓ Court resolved: The Court finds the evidence of knowing misrepresentation overwhelming. Defendan...

  [██████████████░░] 94%  Topic: CONSPIRACY
  [PROSECUTION]: The government maintains defendant deliberately concealed material risks and used investor funds for...
  ⟺  CONTRADICTS
  [DEFENSE]: Defense counsel contends any inaccuracies in financial projections were honest mistakes based on rea...
  ✓ Court resolved: The Court finds the evidence of knowing misrepresentation overwhelming. Defendan...
  ...
  [███████████████░] 96%  Topic: INSIDER TRADING
  [PROSECUTION]: The government maintains defendant deliberately concealed material risks and used investor funds for...
  ⟺  CONTRADICTS
  [DEFENSE]: The defense argues the Fund manager acted in good faith and genuinely believed all representations m...
  ✓ Court resolved: The Court finds the evidence of knowing misrepresentation overwhelming. Defendan...

  [██████████████░░] 94%  Topic: INSIDER TRADING
  [PROSECUTION]: The government maintains defendant deliberately concealed material risks and used investor funds for...
  ⟺  CONTRADICTS
  [DEFENSE]: Defense counsel contends any inaccuracies in financial projections were honest mistakes based on rea...
  ✓ Court resolved: The Court finds the evidence of knowing misrepresentation overwhelming. Defendan...
  ...
  [PROSECUTION]: The prosecution argues defendant knowingly filed materially false financial statements with the SEC ...
  ⟺  CONTRADICTS
  [DEFENSE]: The defense maintains defendant did not sell shares during the relevant period and had no motive to ...
  ✓ Court resolved: The jury finds defendant guilty. Documentary evidence and cooperating witness te...

  [███████████████░] 96%  Topic: EMBEZZLEMENT
  [PROSECUTION]: The government maintains defendant deliberately concealed material risks and used investor funds for...
  ⟺  CONTRADICTS
  [DEFENSE]: The defense argues the Non-profit treasurer acted in good faith and genuinely believed all represent...
  ✓ Court resolved: The Court finds the evidence of knowing misrepresentation overwhelming. Defendan...

  [██████████████░░] 94%  Topic: EMBEZZLEMENT
  [PROSECUTION]: The government maintains defendant deliberately concealed material risks and used investor funds for...
  ⟺  CONTRADICTS
  [DEFENSE]: Defense counsel contends any inaccuracies in financial projections were honest mistakes based on rea...
  ✓ Court resolved: The Court finds the evidence of knowing misrepresentation overwhelming. Defendan...
  ...
  [██████████████░░] 94%  Topic: DRUG TRAFFICKING
  [PROSECUTION]: The government maintains defendant deliberately concealed material risks and used investor funds for...
  ⟺  CONTRADICTS
  [DEFENSE]: The defense argues the Cartel lieutenant acted in good faith and genuinely believed all representati...
  ✓ Court resolved: The Court finds the evidence of knowing misrepresentation overwhelming. Defendan...
  ...
  [███████████████░] 96%  Topic: OBSTRUCTION
  [PROSECUTION]: The government maintains defendant deliberately concealed material risks and used investor funds for...
  ⟺  CONTRADICTS
  [DEFENSE]: The defense argues the Corporate executive acted in good faith and genuinely believed all representa...
  ✓ Court resolved: The Court finds the evidence of knowing misrepresentation overwhelming. Defendan...

  [██████████████░░] 94%  Topic: OBSTRUCTION
  [PROSECUTION]: The government maintains defendant deliberately concealed material risks and used investor funds for...
  ⟺  CONTRADICTS
  [DEFENSE]: Defense counsel contends any inaccuracies in financial projections were honest mistakes based on rea...
  ✓ Court resolved: The Court finds the evidence of knowing misrepresentation overwhelming. Defendan...
...
────────────────────────────────────────────────────────────────────
 Graph saved: ./graph.html
 Open in browser to explore interactively.
════════════════════════════════════════════════════════════════════
Graph saved to Drive: /content/drive/MyDrive/nlp/results/graph.html
